...
export default function BackgroundCricles({}: Props) {
	return (
		<motion.div
			initial={{
				opacity: 0,
			...
			<div className="rounded-full border border-[#85ff4d] opacity-20  h-[650px] w-[650px] absolute mt-52 animate-pulse" />
